...
The following references touch the continuous-time-dynamics and biological-neuron-modeling territory adjacent to the somatic-cognitive coupling described in this filing. Hodgkin-Huxley is included as a citation-required foundational acknowledgment, not as blocking art; Hasani and Maass are listed with substantive distinguish-on points.

- Hodgkin, A. L. and Huxley, A. F. (1952). "A quantitative description of membrane current and its application to conduction and excitation in nerve," Journal of Physiology 117(4):500-544. **Citation-required foundational acknowledgment.** The Hodgkin-Huxley membrane-current formalism is the canonical precedent for treating neural excitation as a propagation phenomenon in a physical medium, and the somatic seas described in this filing inherit that intuition (wave propagation in a medium). **No direct claim overlap:** Hodgkin-Huxley describes single-membrane ionic currents; the present invention covers a multi-organ somatic simulation with cross-organ endocrine IPC, a cognitive substrate modulated by chemical state, emergent heart-rate dynamics, and a cryptographic developmental bond. The acknowledgment is in spirit, not in claim scope.

- Hasani, R. et al. (2020). "Liquid Time-constant Networks," arXiv:2006.04439. **Distinguish-on:** Liquid networks parameterize ODE-driven continuous-time activations at the level of individual neurons. The present invention's somatic seas are field physics across a seven-sea stack with golden-ratio-gated cross-sea bleed; the chemistry layer is a separate, biologically-faithful endocrine simulation with organ-specific synthesis rates and half-life decay that modulates substrate parameters. Liquid networks have no chemistry layer, no cross-sea field bleed, and no organ-level somatic architecture.

- Maass, W. (1997). "Networks of Spiking Neurons: The Third Generation of Neural Network Models," Neural Networks 10(9):1659-1671. **Distinguish-on:** Maass-style spiking networks take spike timing as the unit of computation. The present invention propagates information through cars carrying ordered lineage strands inherited from parent journeys (strand-as-DNA), with information committed only at crystallization. There are no spikes, no spike-timing codes, and no inter-spike-interval semantics; the unit of computation is the cascading strand traversal across the sea topology.
